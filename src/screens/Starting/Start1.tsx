...
const StartingPage1: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        <Image source={require('../../assets/intro/intro1.png')} style={styles.image} />
      </View>
      <Text style={styles.text}>Understand your service coverage and schedules easily</Text>
      ...
      <ActionButton
        title={'Next'}
        onPress={() => navigation.navigate('START2' as never)} 
      />
    </View>
  );
};
